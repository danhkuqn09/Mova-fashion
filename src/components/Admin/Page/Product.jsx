                ...
                <div className="admin-page">
                    <ul className="nav nav-tabs mb-4">
                        <li className="nav-item">
                            <button className={`nav-link ${activeTab === "product" ? "active" : ""}`} onClick={() => setActiveTab("product")}>Sản phẩm</button>
                        </li>
                        <li className="nav-item">
                            <button className={`nav-link ${activeTab === "variant" ? "active" : ""}`} onClick={() => setActiveTab("variant")}>Biến thể (Color & Size)</button>
                        </li>
                    </ul>
                    {activeTab === "product" && (
                        <>
