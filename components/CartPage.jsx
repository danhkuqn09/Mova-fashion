...
const CartPage = () => {
  ...
  // 1. Dữ liệu giỏ hàng mẫu (sẽ thay bằng localStorage hoặc API sau)
    ...
    setCartItems((prevItems) =>
      prevItems.map((item) => {
        if (item.id === itemId) {
          ...
          if (changeType === "increment") newQuantity += 1;
  ...
  // 5. Điều hướng sang trang Checkout và truyền dữ liệu
  ...
  return (
    <div className="main-content-wrapper2 cart-wrapper">
      ...
      <div className="page-header-banner">
        ...
        <p className="breadcrumb" style={{ color: "#ddd" }}>
          Trang Chủ / Giỏ Hàng
        </p>
      </div>
