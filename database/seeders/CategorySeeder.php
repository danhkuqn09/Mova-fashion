    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                ...
                'description' => 'Quần tây công sở, quần tây âu, quần kaki',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'description' => 'Áo khoác jean, áo khoác dù, áo blazer, áo hoodie',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'description' => 'Váy công sở, váy maxi, váy suông, váy xòe',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'description' => 'Đầm công sở, đầm dạ tiệc, đầm maxi',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'description' => 'Áo polo nam nữ, áo polo thể thao',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
